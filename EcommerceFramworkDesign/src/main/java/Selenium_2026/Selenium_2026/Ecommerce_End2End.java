...
public class Ecommerce_End2End {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//a[@id='cartdesk']")).click();
		driver.findElement(By.xpath("//a[@id='checkoutBtn']")).click();
		driver.findElement(By.xpath("//input[@id='firstname']")).sendKeys("John");
		driver.findElement(By.xpath("//input[@id='lastname']")).sendKeys("Cena");
		driver.findElement(By.xpath("//input[@id='email']")).sendKeys("john.cena@gmail.com");
		driver.findElement(By.xpath("//input[@id='phone']")).sendKeys("6753414345");
		driver.findElement(By.xpath("//textarea[@id='address']")).sendKeys("At Post. UK");
		driver.findElement(By.xpath("//input[@id='states']")).sendKeys("UK");
		driver.findElement(By.xpath("//input[@id='city']")).sendKeys("New York");
		driver.findElement(By.xpath("//input[@id='pincode']")).sendKeys("654301");
